...
const bankLoan = new Promise(function (resolve, reject) {
  if (1 >= 0.5) resolve('You bank loan request has been accepted');
  else reject('You loan request has been rejected');
});
