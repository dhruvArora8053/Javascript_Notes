...
//1. Actually we already have a small chain of promises because of below json function so these below two thens called in sequence are basically already a small chain but anyway we will now take chaining to a new level and actually chain together two sequenctial ajax calls:
...
//4. So right we have above 4 steps using then but ofcourse we could extend this as much as we want so even if we wanted the neighbour of neighbour of the neighbour like 10 countries we could easily do this by chaining all these promises one after another and all without the callback hell
