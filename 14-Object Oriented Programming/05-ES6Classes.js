...
//1. Classes are not hoisted and so even if they are class declarations so functional declaration remember are hoisted which means we can use them before they are declared in the code but with classes that doesn't work
